...
function Register({ registerOnSuccess, registerOnFail }) {
    return (
        <>
            ...
            <div class="footer">
                Turn your head to the right for ten seconds to get accurate results
            </div>


            <div role="status" id='spinner'>
                <svg aria-hidden="true" class=" w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-[#00c8B0]" viewBox="0 0 100 101" fill="none" >
